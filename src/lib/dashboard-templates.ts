...
export const DASHBOARD_TEMPLATES: DashboardTemplate[] = [
  ...
  {
    id: "satsdisco-dashboard",
    name: "Satsdisco Dashboard",
    description: "BTC price, Nostr follower counts, and GitHub project stats",
    icon: "₿",
    panels: [
      ...
      { title: "Bender Followers", panel_type: "stat", config: { metric_key: "nostr.bender.followers", data_source: "custom" as const, stat_field: "latest" as const, unit: "followers" }, layout: { x: 4, y: 4, w: 4, h: 2 } },
      { title: "satsdisco Followers", panel_type: "stat", config: { metric_key: "nostr.satsdisco.followers", data_source: "custom" as const, stat_field: "latest" as const, unit: "followers" }, layout: { x: 8, y: 4, w: 4, h: 2 } },
      { title: "numbrs Stars", panel_type: "stat", config: { metric_key: "github.satsdisco.numbrs.stars", data_source: "custom" as const, stat_field: "latest" as const, unit: "⭐" }, layout: { x: 0, y: 6, w: 4, h: 2 } },
      { title: "samizdat Stars", panel_type: "stat", config: { metric_key: "github.satsdisco.samizdat.stars", data_source: "custom" as const, stat_field: "latest" as const, unit: "⭐" }, layout: { x: 4, y: 6, w: 4, h: 2 } },
    ],
  },
  {
    id: "personal-stats",
