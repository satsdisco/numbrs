...
UPDATE public.plex_events SET owner_id = 'REDACTED_OWNER_ID' WHERE owner_id IS NULL;
UPDATE public.jellyfin_events SET owner_id = 'REDACTED_OWNER_ID' WHERE owner_id IS NULL;
